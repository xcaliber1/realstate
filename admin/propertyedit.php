...
if(isset($_POST['add']))
{
	...
	if (!empty($_FILES['aimage']['name'])) {
		...
		// Update the 'pimage' column in the database with the new file name
		$sql = "UPDATE property SET pimage='{$aimage}' WHERE pid = {$pid}";
		...
		// If 'aimage' file input is empty, update only other information without changing the image
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="ptype">
															...
															<option value="building" <?php echo ($row['3'] == "building")? 'selected' : '' ;?> >Condo Unit</option>
												...
												<div class="form-group row mb-3">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="bhk">
															...
															<option value="1 BHK" <?php echo ($row['4'] == "1 BHK")? 'selected' : '' ;?> >1 BHK</option>
															<option value="2 BHK" <?php echo ($row['4'] == "2 BHK")? 'selected' : '' ;?> >2 BHK</option>
															<option value="3 BHK" <?php echo ($row['4'] == "3 BHK")? 'selected' : '' ;?> >3 BHK</option>
															<option value="4 BHK" <?php echo ($row['4'] == "4 BHK")? 'selected' : '' ;?> >4 BHK</option>
															<option value="5 BHK" <?php echo ($row['4'] == "5 BHK")? 'selected' : '' ;?> >5 BHK</option>
															<option value="1,2 BHK" <?php echo ($row['4'] == "1,2 BHK")? 'selected' : '' ;?> >1,2 BHK</option>
															<option value="2,3 BHK" <?php echo ($row['4'] == "2,3 BHK")? 'selected' : '' ;?> >2,3 BHK</option>
															<option value="2,3,4 BHK" <?php echo ($row['4'] == "2,3,4 BHK")? 'selected' : '' ;?> >2,3,4 BHK</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="floor">
															...
															<option value="1st Floor" <?php echo ($row['11'] == "1st Floor")? 'selected' : '' ;?> >1st Floor</option>
															<option value="2nd Floor" <?php echo ($row['11'] == "2nd Floor")? 'selected' : '' ;?> >2nd Floor</option>
															<option value="3rd Floor" <?php echo ($row['11'] == "3rd Floor")? 'selected' : '' ;?> >3rd Floor</option>
															<option value="4th Floor" <?php echo ($row['11'] == "4th Floor")? 'selected' : '' ;?> >4th Floor</option>
															<option value="5th Floor" <?php echo ($row['11'] == "5th Floor")? 'selected' : '' ;?> >5th Floor</option>
														</select>
													</div>
												</div>
												<div class="form-group row">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control" required name="totalfl">
															<option value="">Select Floor</option>
															<option value="1 Floor" <?php echo ($row['28'] == "1 Floor")? 'selected' : '' ;?> >1 Floor</option>
															<option value="2 Floor" <?php echo ($row['28'] == "2 Floor")? 'selected' : '' ;?> >2 Floor</option>
															<option value="3 Floor" <?php echo ($row['28'] == "3 Floor")? 'selected' : '' ;?> >3 Floor</option>
															<option value="4 Floor" <?php echo ($row['28'] == "4 Floor")? 'selected' : '' ;?> >4 Floor</option>
															<option value="5 Floor" <?php echo ($row['28'] == "5 Floor")? 'selected' : '' ;?> >5 Floor</option>
															<option value="6 Floor" <?php echo ($row['28'] == "6 Floor")? 'selected' : '' ;?> >6 Floor</option>
															<option value="7 Floor" <?php echo ($row['28'] == "7 Floor")? 'selected' : '' ;?> >7 Floor</option>
															<option value="8 Floor" <?php echo ($row['28'] == "8 Floor")? 'selected' : '' ;?> >8 Floor</option>
															<option value="9 Floor" <?php echo ($row['28'] == "9 Floor")? 'selected' : '' ;?> >9 Floor</option>
															<option value="10 Floor" <?php echo ($row['28'] == "10 Floor")? 'selected' : '' ;?> >10 Floor</option>
															<option value="11 Floor" <?php echo ($row['28'] == "11 Floor")? 'selected' : '' ;?> >11 Floor</option>
															<option value="12 Floor" <?php echo ($row['28'] == "12 Floor")? 'selected' : '' ;?> >12 Floor</option>
															<option value="13 Floor" <?php echo ($row['28'] == "13 Floor")? 'selected' : '' ;?> >13 Floor</option>
															<option value="14 Floor" <?php echo ($row['28'] == "14 Floor")? 'selected' : '' ;?> >14 Floor</option>
															<option value="15 Floor" <?php echo ($row['28'] == "15 Floor")? 'selected' : '' ;?> >15 Floor</option>
														</select>
													</div>
												</div>
												<div class="form-group row">

                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Maximize your property value with our strategic selling approach, combining innovative marketing and personalized strategies for a seamless, profitable experience.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Simplify the rental process – we match landlords with tenants seamlessly, ensuring a harmonious rental experience for all.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Stand out in the market with our professional property listings, featuring captivating descriptions and visuals that attract the right buyers or tenants.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Navigate real estate investments confidently with our legal support, ensuring your transactions are both financially sound and legally secure.</p>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="admin/property/<?php echo $row['18'];?>" alt="pimage">
                                                ...
                                                <div class="price text-primary"><b>₱<?php echo $row['13'];?> </b><span class="text-white"><?php echo $row['12'];?> Sqm  </span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        <li><span><?php echo $row['12'];?></span> Sqm</li>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>At SouthCity, we take pride in being recognized as a top-rated real estate service provider. Our commitment to excellence is reflected in every aspect of our operations, ensuring that you receive the highest standard of service when it comes to your real estate needs.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Beyond mere transactions, we offer an immersive experience defined by quality. Our dedicated team goes above and beyond, ensuring that your real estate journey is not just satisfactory, but truly exceptional. From the first consultation to the final closing, expect nothing less than top-notch service.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of seasoned professionals brings a wealth of experience to the table. With a proven track record of success, our experienced agents are adept at navigating the complexities of the real estate market. Whether you're buying, selling, or investing, our agents are equipped to deliver outstanding results tailored to your unique goals.</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Initiate the process by engaging in a comprehensive discussion with our experienced team. We believe in understanding your unique needs and preferences to provide personalized solutions. Our expert professionals will guide you through the initial stages, ensuring that your goals are clear and aligned with our services.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Once the discussion phase is complete, we move on to the files review stage. Share relevant documents and information with our team to facilitate a thorough analysis. Our experts will review the provided files diligently, utilizing their expertise to assess the details and lay the groundwork for the next steps in the process.</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Building on insights from discussions and file reviews, we navigate the acquisition stage, leveraging our network for ideal solutions aligned with your goals. Whether finding the perfect property or closing a deal, SouthCity ensures a seamless journey from start to finish. Our dedication is to exceed expectations and deliver exceptional results.</p>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/1.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
									<?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Santo Tomas'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/3.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='Santa Rosa'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>
                        ...
                        <div class="col-md-6 col-lg-3 pb-1">
                            <div class="overflow-hidden position-relative overlay-secondary hover-zoomer mx-n13 z-index-9"> <img src="images/thumbnail4/4.jpg" alt="">
                                <div class="text-white xy-center z-index-9 position-absolute text-center w-100">
                                    <?php
										$query=mysqli_query($con,"SELECT count(state), property.* FROM property where city='San Pablo'");
											while($row=mysqli_fetch_array($query))
												{
										?>
                                    <h4 class="hover-text-success text-capitalize"><a href="stateproperty.php?id=<?php echo $row['17']?>"><?php echo $row['state'];?></a></h4>

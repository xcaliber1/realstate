            ...
            <div class="container">
                <div class="row"><!-- FOR MORE PROJECTS visit: codeastro.com -->
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                ...
                                <?php } else{ ?>
                                    <div class="bg-success d-table px-3 py-2 rounded text-white text-capitalize"><?php echo $row['24'];?></div>
                               <?php };?>
                    ...
                    <div class="col-lg-4">
                        ...
                        <h4 class="double-down-line-left text-secondary position-relative pb-4 my-4">Reserved Now</h4>
                            ...
                            <div class="panel">
                                ...
                                <div class="panel-heading">
                                    <h3 class="panel-title">Charge <?php echo '₱'.$row['13']; ?> with PayPal</h3>
                                    
                                    <!-- Product Info -->
                                    <p><b>Item Name:</b> <?php echo $row['title']; ?></p>
                                    <p><b>Price:</b> <?php echo '₱'.$row['13'].' '.$currency; ?></p>
                                </div>
...
paypal.Buttons({
    ...
    return actions.order.capture().then(function (orderData) {
        ...
        $.ajax({
            type: "POST",
            url: "paypal_checkout_validate.php",
            data: postData,
            dataType: "json",
